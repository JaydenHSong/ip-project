export const en = {
  ...
  reports: {
    ...
    bulk: {
      ...
      submitReview: 'Submit Review ({count})',
      approve: 'Approve ({count})',
      submitSc: 'Submit SC ({count})',
      delete: 'Delete ({count})',
      deselect: 'Deselect',
      brResubmit: 'BR Resubmit',
      archive: 'Archive',
      deleteTitle: 'Delete Reports',
      deleteConfirm: 'Delete {count} selected report(s)? This action cannot be undone.',
    },
    table: {
      channel: 'CH',
      updated: 'Updated',
  ...
  settings: {
    monitoring: {
      title: 'BR Monitoring',
      checksPerDay: 'BR Case Checks Per Day',
      checksPerDayDesc: 'How often the crawler checks BR case status per day.',
      maxDays: 'Max Monitoring Days',
      maxDaysDesc: 'Auto-close as "unresolved" after this many days.',
      cloneThreshold: 'Clone Suggestion Threshold (days)',
      cloneThresholdDesc: 'Show "Clone suggested" badge after this many days without resolution.',
      onceDaily: 'Once daily',
      twiceDaily: 'Twice daily',
      threeDaily: '3 times daily',
      fourDaily: '4 times daily',
      save: 'Save',
      saved: 'Saved',
    },
    autoDraft: {
      title: 'Auto Draft',
      description: 'Automatically generate AI tone/manner suggestions when new reports are created with complete data.',
      enable: 'Enable Auto Draft',
      conditionsTitle: 'Auto Draft runs when:',
      conditionAsin: 'ASIN is present',
      conditionFormType: 'BR form type is selected',
      conditionScreenshot: 'Screenshot is attached',
      perFormType: 'Per Form Type',
      ipWarning: 'IP',
      save: 'Save',
      saved: 'Saved',
    },
    ...
    aiPrompts: {
      title: 'AI Prompts',
      description: 'Manage and optimize AI prompt versions. Opus analyzes accuracy weekly and suggests improvements.',
      optimize: 'Optimize',
      systemPrompt: 'System Prompt',
      systemPromptDesc: 'Shared system prompt for all AI calls',
      toneSuggest: 'Tone Suggest',
      toneSuggestDesc: 'Template tone/manner refinement prompt',
      crawlerViolation: 'Crawler Violation Scan',
      crawlerViolationDesc: 'Crawler AI violation detection prompt',
      crawlerThumbnail: 'Crawler Thumbnail Scan',
      crawlerThumbnailDesc: 'Crawler thumbnail policy check prompt',
    },
    users: {
