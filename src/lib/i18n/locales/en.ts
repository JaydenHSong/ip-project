export const en = {
  ...
  settings: {
    ...
    scAutomation: {
      title: 'BR Auto Submit',
      description: 'Configure Brand Registry automatic submission.',
      ...
      note: 'Credentials are managed via Crawler environment variables (Railway). Not stored in DB for security.',
      save: 'Save Settings',
      saved: 'Settings saved.',
