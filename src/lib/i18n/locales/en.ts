export const en = {
  ...
  reports: {
    ...
    detail: {
      ...
      scSubmitting: 'Submitting to SC...',
      scSubmittingAttempt: 'SC Submission in progress (attempt {n}/3)',
      scRetry: 'Retry SC Submit',
      scFailed: 'SC submission failed',
