export const ko = {
  ...
  reports: {
    ...
    bulk: {
      selected: '{count}건 선택',
      submitReview: '검토 제출 ({count})',
      approve: '승인 ({count})',
      submitSc: 'SC 제출 ({count})',
      delete: '삭제 ({count})',
      deselect: '선택 해제',
      brResubmit: 'BR 재신고',
      archive: '보관',
      deleteTitle: '신고 삭제',
      deleteConfirm: '선택한 {count}건을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
    },
    table: {
      channel: 'CH',
      updated: '수정일',
  ...
  settings: {
    monitoring: {
      title: 'BR 모니터링',
      checksPerDay: 'BR 케이스 일일 체크 횟수',
      checksPerDayDesc: '크롤러가 하루에 BR 케이스 상태를 확인하는 횟수입니다.',
      maxDays: '최대 모니터링 기간 (일)',
      maxDaysDesc: '이 기간 후 미해결로 자동 종료됩니다.',
      cloneThreshold: '클론 제안 기준 (일)',
      cloneThresholdDesc: '이 기간 동안 미해결 시 "클론 권장" 뱃지를 표시합니다.',
      onceDaily: '하루 1회',
      twiceDaily: '하루 2회',
      threeDaily: '하루 3회',
      fourDaily: '하루 4회',
    ...
    autoDraft: {
      title: '자동 드래프트',
      description: '새 리포트 생성 시 데이터가 충분하면 AI 톤/매너 제안을 자동 생성합니다.',
      enable: '자동 드래프트 활성화',
      conditionsTitle: '자동 드래프트 실행 조건:',
      conditionAsin: 'ASIN이 있을 때',
      conditionFormType: 'BR 폼 타입이 선택되었을 때',
      conditionScreenshot: '스크린샷이 첨부되었을 때',
      perFormType: '폼 타입별 설정',
      ipWarning: 'IP',
      save: '저장',
      saved: '저장됨',
    },
    ...
    aiPrompts: {
      title: 'AI 프롬프트',
      description: 'AI 프롬프트 버전을 관리하고 최적화합니다. Opus가 주간 정확도를 분석하고 개선을 제안합니다.',
      optimize: '최적화',
      systemPrompt: '시스템 프롬프트',
      systemPromptDesc: '모든 AI 호출에 사용되는 공통 시스템 프롬프트',
      toneSuggest: '톤 제안',
      toneSuggestDesc: '템플릿 톤/매너 개선 프롬프트',
      crawlerViolation: '크롤러 위반 스캔',
      crawlerViolationDesc: '크롤러 AI 위반 탐지 프롬프트',
      crawlerThumbnail: '크롤러 썸네일 스캔',
      crawlerThumbnailDesc: '크롤러 썸네일 정책 검사 프롬프트',
    },
    users: {
      title: '사용자 관리',
