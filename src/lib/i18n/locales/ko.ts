export const ko = {
  ...
  reports: {
    ...
    detail: {
      ...
      scSubmitting: 'PD Reporting 중...',
      scSubmittingAttempt: 'PD Reporting 진행 중 (시도 {n}/3)',
      scRetry: 'PD 재시도',
  ...
  settings: {
    ...
    scAutomation: {
      title: 'SC 자동 제출',
      description: 'Seller Central 자동 제출을 설정합니다. Crawler가 SC 폼 제출을 자동으로 처리합니다.',
