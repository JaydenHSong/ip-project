    ...
    <div className="flex min-h-screen items-center justify-center bg-th-bg-secondary">
      <div className="w-full max-w-md space-y-8 rounded-xl border border-th-border bg-surface-card p-8 shadow-lg">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-th-border bg-surface-card px-4 py-3 text-sm font-medium text-th-text shadow-sm transition-colors hover:bg-th-bg-hover focus:outline-none focus:ring-2 focus:ring-th-accent focus:ring-offset-2"
        >
