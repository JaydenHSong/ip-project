    ...
    return buildTimelineEvents(
      {
        ...
        pd_case_id: data.pd_case_id as string | null,
        pd_submitted_at: data.pd_submitted_at as string | null,
      ...
      {!loading && data && (
        ...
        <ReportDetailContent
          report={{
            ...
            rejection_reason: data.rejection_reason as string | null,
            pd_case_id: data.pd_case_id as string | null,
            pd_submission_error: data.pd_submission_error as string | null,
            pd_submit_attempts: (data.pd_submit_attempts as number) ?? 0,
            pd_submit_data: data.pd_submit_data as { pd_rav_url?: string; asin?: string; marketplace?: string } | null,
