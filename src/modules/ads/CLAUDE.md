...
| 페이지 | 경로 | 설명 |
|:--|:--|:--|
| Dashboard | `/ads/dashboard` | AD 성과 대시보드 (CEO/Director/Marketer 역할별 뷰) |
| Campaigns | `/ads/campaigns` | 광고 캠페인 관리 + 자동 생성 |
| Optimization | `/ads/optimization` | 최적화 엔진 (Bidding / Budget / Keywords / Dayparting 탭) |
| Auto Pilot | `/ads/autopilot` | Full Auto Pilot 자율 운영 |
| Reports | `/ads/reports` | 광고 리포트 + 구글시트 연동 |
